...
import type { Adapter, WalletName } from '@solarti/wallet-adapter-base';
import { BaseWalletAdapter, WalletError, WalletNotReadyError, WalletReadyState } from '@solarti/wallet-adapter-base';
