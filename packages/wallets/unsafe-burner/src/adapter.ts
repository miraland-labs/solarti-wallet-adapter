...
import { BaseSignerWalletAdapter, WalletNotConnectedError, WalletReadyState } from '@solarti/wallet-adapter-base';
import type { PublicKey, Transaction, TransactionVersion, VersionedTransaction } from '@solarti/web3.js';
...
export class UnsafeBurnerWalletAdapter extends BaseSignerWalletAdapter {
    ...
    url = 'https://github.com/miraland-labs/solarti-wallet-adapter#usage';
    icon =
    ...
    constructor() {
        ...
        console.warn(
            'Your application is presently configured to use the `UnsafeBurnerWalletAdapter`. ' +
                ...
                'https://github.com/miraland-labs/solarti-wallet-adapter#usage for an example.'
        );
    }
