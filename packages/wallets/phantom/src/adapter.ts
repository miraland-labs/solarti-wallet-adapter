import type { EventEmitter, SendTransactionOptions, WalletName } from '@solarti/wallet-adapter-base';
import {
...
import type { Connection, SendOptions, Transaction, TransactionSignature } from '@solarti/web3.js';
